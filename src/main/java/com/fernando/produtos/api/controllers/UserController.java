...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<RecoveryJwtTokenRequest> authenticateUser(@RequestBody LoginUserRequests loginUserDto) {
        RecoveryJwtTokenRequest token = userService.authenticateUser(loginUserDto);
        return new ResponseEntity<>(token, HttpStatus.OK);
    }

    @PostMapping
    public ResponseEntity<Void> createUser(@RequestBody CreateUserRequest createUserDto) {
